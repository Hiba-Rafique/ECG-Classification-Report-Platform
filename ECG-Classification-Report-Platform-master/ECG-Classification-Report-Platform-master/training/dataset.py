...
This is the LOCAL training path for the deployed single-label model
(models/weights/best_model.pth). The Kaggle notebook training/ecg-train.ipynb
trains the multi-label variant; the shared conventions are the same:
